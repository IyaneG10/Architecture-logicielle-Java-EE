...
public class DataAPI {
    ...
    @GetMapping("realtime/room{room_id}/{measureName}")
    public ResponseEntity<String> getRealTimeDataByRoom(@PathVariable("room_id") int room_id,@PathVariable("measureName") String measureName)  throws SQLException, JSONException {
        return new ResponseEntity<String>(getRealTimeData(room_id, measureName)+ "", HttpStatus.OK);
    }
